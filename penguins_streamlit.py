# Import libraries, set up the title  and load the model
import streamlit as st
import seaborn as sns
import matplotlib.pyplot as plt
import pandas as pd
import pickle
st.title('Penguin Classifier V2')
...
rf_pickle.close()
map_pickle.close()
# Grabs all the user input we need for our prediction
...
# Create histogram to explain the prediction by the model
